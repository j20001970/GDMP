...
const protobuf::FieldDescriptor *util::get_field_descriptor(protobuf::Message **message, const String &field_name, const String &delimiter) {
	PoolStringArray names = field_name.split(delimiter);
...
Variant util::get_field(const protobuf::Message &message, const protobuf::FieldDescriptor *field) {
	...
	switch (field->type()) {
		...
		case protobuf::FieldDescriptor::TYPE_MESSAGE: {
			...
			return MediaPipeProto::_new(proto);
		}
	...
	switch (field->type()) {
		...
		case protobuf::FieldDescriptor::TYPE_MESSAGE: {
			...
			for (int i = 0; i < size; i++) {
				...
				array[i] = MediaPipeProto::_new(proto);
			}
			return array;
		}
		case protobuf::FieldDescriptor::TYPE_BYTES: {
...
bool util::set_field(protobuf::Message &message, const protobuf::FieldDescriptor *field, Variant value) {
	...
	switch (field->type()) {
		...
		case protobuf::FieldDescriptor::TYPE_FLOAT:
			return _set_field(message, field, refl, value, Variant::REAL, &protobuf::Reflection::SetFloat);
		case protobuf::FieldDescriptor::TYPE_DOUBLE:
			return _set_field(message, field, refl, value, Variant::REAL, &protobuf::Reflection::SetDouble);
		case protobuf::FieldDescriptor::TYPE_STRING: {
		...
		case protobuf::FieldDescriptor::TYPE_BYTES: {
			ERR_FAIL_COND_V(value.get_type() != Variant::POOL_BYTE_ARRAY, false);
...
bool util::set_repeated_field(protobuf::Message &message, const protobuf::FieldDescriptor *field, int index, Variant value) {
	...
	switch (field->type()) {
		...
		case protobuf::FieldDescriptor::TYPE_FLOAT:
			return _set_repeated_field(message, field, refl, value, Variant::Type::REAL, index, &protobuf::Reflection::SetRepeatedFloat);
		case protobuf::FieldDescriptor::TYPE_DOUBLE:
			return _set_repeated_field(message, field, refl, value, Variant::Type::REAL, index, &protobuf::Reflection::SetRepeatedDouble);
		case protobuf::FieldDescriptor::TYPE_STRING: {
			ERR_FAIL_COND_V(value.get_type() != Variant::STRING, false);
			String string = value;
...
bool _set_repeated_field(
	...
	for (int i = 0; i < array.size(); i++) {
		ERR_CONTINUE(array[i].get_type() != type);
...
bool util::set_repeated_field(protobuf::Message &message, const protobuf::FieldDescriptor *field, Variant value) {
	...
	switch (field->type()) {
		...
		case protobuf::FieldDescriptor::TYPE_ENUM:
			if (value.get_type() == Variant::POOL_INT_ARRAY) {
				value = Array(value);
			}
		...
		case protobuf::FieldDescriptor::TYPE_FLOAT:
			if (value.get_type() == Variant::POOL_REAL_ARRAY) {
				value = Array(value);
			}
			return _set_repeated_field(message, field, refl, value, Variant::REAL, &protobuf::Reflection::AddFloat);
		case protobuf::FieldDescriptor::TYPE_DOUBLE:
			if (value.get_type() == Variant::POOL_REAL_ARRAY) {
				value = Array(value);
			}
			return _set_repeated_field(message, field, refl, value, Variant::REAL, &protobuf::Reflection::AddDouble);
		case protobuf::FieldDescriptor::TYPE_STRING: {
			if (value.get_type() == Variant::POOL_STRING_ARRAY) {
				value = Array(value);
			}
			ERR_FAIL_COND_V(value.get_type() != Variant::ARRAY, false);
			Array array = value;
			refl->ClearField(&message, field);
			for (int i = 0; i < array.size(); i++) {
				ERR_CONTINUE(array[i].get_type() != Variant::STRING);
		...
		case protobuf::FieldDescriptor::TYPE_BYTES: {
			...
			refl->ClearField(&message, field);
			for (int i = 0; i < array.size(); i++) {
				ERR_CONTINUE(array[i].get_type() != Variant::POOL_BYTE_ARRAY);
				PoolByteArray bytes = array[i];
				std::string string = std::string((char *)bytes.ptr(), bytes.size());
